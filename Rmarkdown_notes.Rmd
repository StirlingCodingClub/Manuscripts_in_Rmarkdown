...
Importantly, **the 'default' following 'word_document' above has been removed**. This tells Rmarkdown not to just go with the defaults for creating a DOCX file; the indented 'refrence_docx' specifies to use 'docx_template.docx' as the template instead.
