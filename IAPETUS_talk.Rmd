...
| Time             | Activity                                                |
| ---------------- | ------------------------------------------------------- |
| 14:00 -- 14:30   | Presentation introducing Rmarkdown (14:00-14:30)        |
| 14:30 -- 15:00   | Getting started with knitr and references (14:30-15:00) |
| 15:00 -- 15:20   | Integrating R analysis (15:00-15:20)                    |
| 15:20 -- 16:00   | Self-guided writing with Rmarkdown (15:20-16:00)        |
| 16:00 -- 16:30   | Tea break (16:00-16:30)                                 |
| 17:00 -- 17:30   | Creating presentations (17:00-17:30)                    |
| 17:30 -- 18:00   | Adding shiny to Rmarkdown (17:30-18:00)                 |
...
Code below reads in the [Bumpus sparrow](https://github.com/StirlingCodingClub/Manuscripts_in_Rmarkdown/blob/master/data/Bumpus_data.csv) data set.

```{r}
dat <- read.csv(file = "data/Bumpus_data.csv");
```

Mean sparrow length is `r round(mean(dat$totlen), digits = 2)`. This number is printed with the code ([see line](https://github.com/StirlingCodingClub/Manuscripts_in_Rmarkdown/blob/master/IAPETUS_talk.Rmd#L489)): 
