...
Mean sparrow length is `r round(mean(dat$totlen), digits = 2)`. This number is printed with the code ([see line]()): 
...
**A new YAML addition `bibliography: refs.bib` allows for citations.**
